...
public class ExternalPrivateFragment extends Fragment {
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_external_private, container, false);
        initView();
    ...
    public void loadData(List<String> promos, List<PrivateTeacher> teachers) {
        ...
        ExternalPrivateTeacherListAdapter externalPrivateTeacherListAdpt = new ExternalPrivateTeacherListAdapter(teachers);
        teacherListView.setAdapter(externalPrivateTeacherListAdpt);
