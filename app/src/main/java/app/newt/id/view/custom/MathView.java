...
public class MathView extends WebView {
    ...
    public MathView(Context context, AttributeSet attrs) {
        ...
        TypedArray mTypeArray = context.getTheme().obtainStyledAttributes(
                attrs,
                katex.hourglass.in.mathlib.R.styleable.MathView,
                0, 0);
        try {
            setBackgroundColor(mTypeArray.getInteger(katex.hourglass.in.mathlib.R.styleable.MathView_setViewBackgroundColor, ContextCompat.getColor(context, android.R.color.transparent)));
            setTextColor(mTypeArray.getColor(katex.hourglass.in.mathlib.R.styleable.MathView_setTextColor, ContextCompat.getColor(context, android.R.color.black)));
            pixelSizeConversion(mTypeArray.getDimension(katex.hourglass.in.mathlib.R.styleable.MathView_setTextSize, default_text_size));
            setDisplayText(mTypeArray.getString(katex.hourglass.in.mathlib.R.styleable.MathView_setText));
            setClickable(mTypeArray.getBoolean(katex.hourglass.in.mathlib.R.styleable.MathView_setClickable, false));
